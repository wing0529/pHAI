...
def get_args():
    ...
    parser.add_argument('--input', '-i', help='Input image filename', dest='input',
                        default='C:/aproject/GRED/test/water.jpg.')
    parser.add_argument('--output_dir', '-o', default='C:/aproject/GRED/testout/water.jpg',
                        help='Directory to save the output images', dest='out_dir')
    parser.add_argument('--task', '-t', default='editing',
