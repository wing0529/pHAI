...
public final class ManagingProductBinding implements ViewBinding {
  @NonNull
  ...
  private ManagingProductBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView answerTextView, @NonNull ImageButton backButton,
  ...
  @NonNull
  public static ManagingProductBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ManagingProductBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.managing_product, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ManagingProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ManagingProductBinding((ConstraintLayout) rootView, answerTextView, backButton,
