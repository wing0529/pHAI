...
public final class SymptomsExplainBinding implements ViewBinding {
  @NonNull
  ...
  private SymptomsExplainBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView answer1TextView, @NonNull TextView answer2TextView,
      @NonNull TextView answer3TextView, @NonNull ImageButton backButton,
      @NonNull TextView questionTextView, @NonNull ScrollView scrollView,
  ...
  @NonNull
  public static SymptomsExplainBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SymptomsExplainBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.symptoms_explain, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SymptomsExplainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SymptomsExplainBinding((ConstraintLayout) rootView, answer1TextView,
          answer2TextView, answer3TextView, backButton, questionTextView, scrollView,
